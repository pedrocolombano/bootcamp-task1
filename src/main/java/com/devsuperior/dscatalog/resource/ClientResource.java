...
public class ClientResource {
	...
	@GetMapping
	public ResponseEntity<Page<Client>> findAll(@RequestParam(name = "page", defaultValue = "0") Integer page,
		...
		Page<Client> clients = this.clientService.findAllPaged(pageRequest);
